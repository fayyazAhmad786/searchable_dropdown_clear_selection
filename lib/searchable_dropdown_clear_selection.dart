library searchable_dropdown_clear_selection;
...
class SearchableDropDownClearSelection extends StatefulWidget {
  // Add a callback variable for the clear button
  ...
  @override
  _SearchableDropDownClearSelectionState createState() => _SearchableDropDownClearSelectionState();
}

class _SearchableDropDownClearSelectionState extends State<SearchableDropDownClearSelection>
                    ...
                    children: [
                      ...
                      Visibility(
                        ...
                        child: TextButton(
                          ...
                          child: Icon(Icons.clear),
                          onPressed: () {
                            // Invoke the clear button callback
